          ...
          <div className="flex items-center gap-2">
            {project.hasMemory && (
              <button
                ...
                className="flex items-center gap-1 px-1.5 py-0.5 text-[10px] font-medium tracking-wide rounded bg-amber-500/10 text-amber-500/80 hover:bg-amber-500/20 hover:text-amber-500 transition-colors"
              >
